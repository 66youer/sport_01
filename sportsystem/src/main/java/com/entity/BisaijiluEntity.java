 ...
 */
@TableName("bisaijilu")
public class BisaijiluEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public BisaijiluEntity() {
		
	}
	
	public BisaijiluEntity(T t) {
		try {
	 ...
	 * 设置：比赛记录
	 */
	public void setBisaijilu(String bisaijilu) {
		this.bisaijilu = bisaijilu;
	}
	/**
	 * 获取：比赛记录
	 */
	public String getBisaijilu() {
		return bisaijilu;
	}
	/**
	 * 设置：跨表用户id

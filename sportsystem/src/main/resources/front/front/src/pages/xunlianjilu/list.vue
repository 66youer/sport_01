		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.xunlianjilu" placeholder="训练记录" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-button class="list-search-btn" v-if=" true " type="primary" @click="getList(1, curFenlei)">
					<i class="el-icon-search"></i>
					查询
				</el-button>
				<el-button class="list-add-btn" v-if="btnAuth('xunlianjilu','新增')" type="primary" @click="add('/index/xunlianjiluAdd')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				let searchWhere = {};
				if (this.formSearch.xunlianjilu != '') searchWhere.xunlianjilu = '%' + this.formSearch.xunlianjilu + '%';
				if(!this.centerType){
					params['sfsh'] = '是';
				}
				...
				this.$http.get(`xunlianjilu/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/xunlianjiluDetail', query: params});
			},

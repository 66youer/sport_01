<template>
	<div class="center-preview">
		...
		<div class="center-info">
			...
			<div class="img-box" v-if="userTableName=='yundongyuan'">
				<img :src="sessionForm.touxiang?baseUrl + sessionForm.touxiang:require('@/assets/avator.png')">
			</div>
			<div class="img-box" v-if="userTableName=='jiaolianyuan'">
				<img :src="sessionForm.touxiang?baseUrl + sessionForm.touxiang:require('@/assets/avator.png')">
			</div>
			...
			<div class="info-item1" v-if="userTableName=='yundongyuan'">
				<span class="icon iconfont "></span>
				<div class="label">账号：</div>
				<div class="text">{{sessionForm.zhanghao}}</div>
			</div>
			<div class="info-item2" v-if="userTableName=='yundongyuan'">
				<span class="icon iconfont "></span>
				<div class="label">姓名：</div>
				<div class="text">{{sessionForm.xingming}}</div>
			</div>
			<div class="info-item3" v-if="userTableName=='yundongyuan'">
				<span class="icon iconfont "></span>
				<div class="label">性别：</div>
				<div class="text">{{sessionForm.xingbie}}</div>
			</div>
			<div class="info-item4" v-if="userTableName=='yundongyuan'">
				<span class="icon iconfont "></span>
				<div class="label">年龄：</div>
				<div class="text">{{sessionForm.nianling}}</div>
			</div>
			<div class="info-item5" v-if="userTableName=='yundongyuan'">
				<span class="icon iconfont "></span>
				<div class="label">手机号码：</div>
				<div class="text">{{sessionForm.shoujihaoma}}</div>
			</div>
			<div class="info-item6" v-if="userTableName=='yundongyuan'">
				<span class="icon iconfont "></span>
				<div class="label">投票数：</div>
				<div class="text">{{sessionForm.toupiaoshu}}</div>
			</div>
			<div class="info-item1" v-if="userTableName=='jiaolianyuan'">
				<span class="icon iconfont "></span>
				<div class="label">教练工号：</div>
				<div class="text">{{sessionForm.jiaoliangonghao}}</div>
			</div>
			<div class="info-item2" v-if="userTableName=='jiaolianyuan'">
				<span class="icon iconfont "></span>
				<div class="label">教练姓名：</div>
				<div class="text">{{sessionForm.jiaolianxingming}}</div>
			</div>
			<div class="info-item3" v-if="userTableName=='jiaolianyuan'">
				<span class="icon iconfont "></span>
				<div class="label">性别：</div>
				<div class="text">{{sessionForm.xingbie}}</div>
			</div>
			<div class="info-item4" v-if="userTableName=='jiaolianyuan'">
				<span class="icon iconfont "></span>
				<div class="label">年龄：</div>
				<div class="text">{{sessionForm.nianling}}</div>
			</div>
			<div class="info-item5" v-if="userTableName=='jiaolianyuan'">
				<span class="icon iconfont "></span>
				<div class="label">手机号码：</div>
				<div class="text">{{sessionForm.shoujihaoma}}</div>
			</div>
			<div class="info-item6" v-if="userTableName=='jiaolianyuan'">
				<span class="icon iconfont "></span>
				<div class="label">余额：</div>
				<div class="text">{{sessionForm.money}}</div>
			</div>
		...
		<el-tabs class="center-tabs" tab-position="left" @tab-click="handleClick">
			<el-tab-pane label="个人中心">
				<el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="180px">
					...
					<el-form-item class="center-item" v-if="userTableName=='yundongyuan'" label="账号" prop="zhanghao">
						<el-input v-model="sessionForm.zhanghao" placeholder="账号" readonly></el-input>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='yundongyuan'" label="姓名" prop="xingming">
						<el-input v-model="sessionForm.xingming" placeholder="姓名" ></el-input>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='yundongyuan'" label="头像" prop="touxiang">
						<file-upload
							tip="点击上传头像"
							action="file/upload"
							:limit="1"
							:multiple="true"
							:fileUrls="sessionForm.touxiang?sessionForm.touxiang:''"
							@change="yundongyuantouxiangHandleAvatarSuccess"
							></file-upload>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='yundongyuan'" label="性别" prop="xingbie">
						<el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
							<el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
						</el-select>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='yundongyuan'" label="年龄" prop="nianling">
						<el-input v-model="sessionForm.nianling" placeholder="年龄" ></el-input>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='yundongyuan'" label="手机号码" prop="shoujihaoma">
						<el-input v-model="sessionForm.shoujihaoma" placeholder="手机号码" ></el-input>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='yundongyuan'" label="投票数" prop="toupiaoshu">
						<el-input v-model="sessionForm.toupiaoshu" placeholder="投票数" readonly></el-input>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='yundongyuan'" label="余额">
						<div class="balance-item">
							<el-input v-model="sessionForm.money" placeholder="余额" readonly></el-input>
							<div class="balanceBtn" @click="dialogFormVisibleMoney = true">
								<span class="icon iconfont icon-tijiaoyanzi"></span>
					...
					<el-form-item class="center-item" v-if="userTableName=='jiaolianyuan'" label="教练工号" prop="jiaoliangonghao">
						<el-input v-model="sessionForm.jiaoliangonghao" placeholder="教练工号" readonly></el-input>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='jiaolianyuan'" label="教练姓名" prop="jiaolianxingming">
						<el-input v-model="sessionForm.jiaolianxingming" placeholder="教练姓名" ></el-input>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='jiaolianyuan'" label="头像" prop="touxiang">
						<file-upload
							tip="点击上传头像"
							action="file/upload"
							:limit="1"
							:multiple="true"
							:fileUrls="sessionForm.touxiang?sessionForm.touxiang:''"
							@change="jiaolianyuantouxiangHandleAvatarSuccess"
							></file-upload>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='jiaolianyuan'" label="性别" prop="xingbie">
						<el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
							<el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
						</el-select>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='jiaolianyuan'" label="年龄" prop="nianling">
						<el-input v-model="sessionForm.nianling" placeholder="年龄" ></el-input>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='jiaolianyuan'" label="手机号码" prop="shoujihaoma">
						<el-input v-model="sessionForm.shoujihaoma" placeholder="手机号码" ></el-input>
					</el-form-item>
					<el-form-item class="center-item" v-if="userTableName=='jiaolianyuan'" label="余额">
						<div class="balance-item">
							<el-input v-model="sessionForm.money" placeholder="余额" readonly></el-input>
							<div class="balanceBtn" @click="dialogFormVisibleMoney = true">
								<span class="icon iconfont icon-tijiaoyanzi"></span>
...
<script>
	...
	export default {
		...
		created() {
			...
			if ('yundongyuan' == this.userTableName) {
			...
			if ('yundongyuan' == this.userTableName) {
				this.$set(this.sessionForm, 'toupiaoshu', null);
			}
			if ('yundongyuan' == this.userTableName) {
			...
			if ('jiaolianyuan' == this.userTableName) {
				this.$set(this.sessionForm, 'jiaoliangonghao', null);
			}
			if ('jiaolianyuan' == this.userTableName) {
				this.$set(this.sessionForm, 'mima', null);
			}
			...
			if ('yundongyuan' == this.userTableName&&this.rules['zhanghao']){
				this.rules['zhanghao'].push({ required: true, message: '请输入账号', trigger: 'blur' })
			}else if('yundongyuan' == this.userTableName&&!this.rules['zhanghao']) {
				this.$set(this.rules, 'zhanghao', [{ required: true, message: '请输入账号', trigger: 'blur' }]);
			}
			if ('yundongyuan' == this.userTableName&&this.rules['mima']){
				this.rules['mima'].push({ required: true, message: '请输入密码', trigger: 'blur' })
			}else if('yundongyuan' == this.userTableName&&!this.rules['mima']) {
				this.$set(this.rules, 'mima', [{ required: true, message: '请输入密码', trigger: 'blur' }]);
			}
			if ('yundongyuan' == this.userTableName&&this.rules['xingming']){
				this.rules['xingming'].push({ required: true, message: '请输入姓名', trigger: 'blur' })
			}else if('yundongyuan' == this.userTableName&&!this.rules['xingming']) {
			...
			if ('yundongyuan' == this.userTableName) {
				this.$set(this.rules, 'toupiaoshu', [{ required: false, validator: this.$validate.isIntNumer, trigger: 'blur' }]);
			}
			if ('yundongyuan' == this.userTableName) {
			...
			if ('jiaolianyuan' == this.userTableName&&this.rules['mima']){
				this.rules['mima'].push({ required: true, message: '请输入密码', trigger: 'blur' })
			}else if('jiaolianyuan' == this.userTableName&&!this.rules['mima']) {
				this.$set(this.rules, 'mima', [{ required: true, message: '请输入密码', trigger: 'blur' }]);
			}
			if ('jiaolianyuan' == this.userTableName&&this.rules['jiaolianxingming']){
				this.rules['jiaolianxingming'].push({ required: true, message: '请输入教练姓名', trigger: 'blur' })
			}else if('jiaolianyuan' == this.userTableName&&!this.rules['jiaolianxingming']) {
				this.$set(this.rules, 'jiaolianxingming', [{ required: true, message: '请输入教练姓名', trigger: 'blur' }]);
			}
			if ('jiaolianyuan' == this.userTableName) {
				this.$set(this.rules, 'nianling', [{ required: false, validator: this.$validate.isIntNumer, trigger: 'blur' }]);
			}
		...
		methods: {
			...
			onSubmit(formName) {
				...
				if(`yundongyuan` == this.userTableName && this.sessionForm.touxiang!=null){
					this.sessionForm.touxiang = this.sessionForm.touxiang.replace(new RegExp(this.$config.baseUrl,"g"),"");
				}
				if(`jiaolianyuan` == this.userTableName && this.sessionForm.touxiang!=null){
					this.sessionForm.touxiang = this.sessionForm.touxiang.replace(new RegExp(this.$config.baseUrl,"g"),"");
				}
			...
			yundongyuantouxiangHandleAvatarSuccess(fileUrls) {
				this.sessionForm.touxiang = fileUrls;
			},
			jiaolianyuantouxiangHandleAvatarSuccess(fileUrls) {
				this.sessionForm.touxiang = fileUrls;
			},
			chongzhi() {
			...
			async updatePassword(){
				this.$refs["passwordForm"].validate(async valid => {
					if (valid) {
						...
						if (this.userTableName == 'yundongyuan') {
						}
						if (this.userTableName == 'jiaolianyuan') {
						}

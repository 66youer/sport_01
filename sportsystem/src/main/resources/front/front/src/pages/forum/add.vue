		...
		<el-form class="add-update-preview" :model="form" :rules="rules" ref="form" label-width="180px">
			...
			<el-form-item :style='{"padding":"6px 0 0","margin":"0 0 20px 0","borderColor":"#475a8310","borderRadius":"0px","background":"none","borderWidth":" 0 0 0px","borderStyle":"solid"}' label="内容" prop="content">
				<editor
					...
					:style='{"minHeight":"350px","border":"1px solid #666","boxShadow":"0 0 0px rgba(80, 80, 80, .2)","color":"#333","borderRadius":"0px","background":"#fff","width":"100%","lineHeight":"32px","fontSize":"14px"}'
			...
			<el-form-item :style='{"padding":"0","margin":"20px 0"}'>
				<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 20px 0 0","textAlign":"center","display":"inline-block","minWidth":"120px","borderRadius":"4px","background":"#848c74","width":"auto","lineHeight":"42px","fontSize":"16px","height":"42px"}' type="primary" @click="submitForm('form')">
					<span class="icon iconfont " :style='{"color":"#fff"}'></span>
					<span class="text" :style='{"color":"#fff"}'>{{this.isEdit ? '修改' : '发布帖子'}}</span>
				</el-button>
				<el-button :style='{"border":"0px solid #ddd","cursor":"pointer","padding":"0 24px","margin":"0 20px 0 0","color":"#fff","textAlign":"center","display":"inline-block","minWidth":"120px","borderRadius":"4px","background":"#858585","width":"auto","lineHeight":"42px","fontSize":"16px","height":"42px"}' @click="resetForm('form')">
					<span class="icon iconfont " :style='{"color":"#fff"}'></span>

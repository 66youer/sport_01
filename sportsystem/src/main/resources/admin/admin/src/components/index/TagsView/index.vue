<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"0","margin":"0px auto 0 20px","borderColor":"#3b6885","borderWidth":"0 0 0px 0","background":"#fff","display":"none","width":"calc(100% - 40px)","fontSize":"16px","borderStyle":"solid"}'>

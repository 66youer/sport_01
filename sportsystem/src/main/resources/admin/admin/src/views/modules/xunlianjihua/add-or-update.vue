<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item class="textarea" v-if="type!='info'" label="训练任务" prop="xunlianrenwu" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="训练任务"
					v-model="ruleForm.xunlianrenwu" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.xunlianrenwu" label="训练任务" prop="xunlianrenwu" >
				<span class="text">{{ruleForm.xunlianrenwu}}</span>
			</el-form-item>
		...
		data() {
			return {
				...
				rules: {
					...
					xunlianrenwu: [
						{ required: true, message: '训练任务不能为空', trigger: 'blur' },
					],
					tupian: [
					],
					jiaoliangonghao: [
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='xunlianrenwu'){
							this.ruleForm.xunlianrenwu = obj[o];
							this.ro.xunlianrenwu = true;
							continue;
						}
						if(o=='tupian'){

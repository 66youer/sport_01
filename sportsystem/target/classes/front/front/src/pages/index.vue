	...
	<div class="main-containers">
		<div class="body-containers">
			<div class="top-container">
				<!-- info -->
				<div class="top_title">
					<span @click="goMenu('/index/home')">体育类信息管理系统</span>
				</div>
		...
		async getSession() {
			await this.$http.get(`${localStorage.getItem('UserTableName')}/session`, {emulateJSON: true}).then(async res => {
				if (res.data.code == 0) {
					...
					if(localStorage.getItem('UserTableName')== 'yundongyuan') {
						localStorage.setItem('username', res.data.data.zhanghao);
					}
					if(localStorage.getItem('UserTableName')== 'jiaolianyuan') {
						localStorage.setItem('username', res.data.data.jiaoliangonghao);
					}
